...
const en = {
  ...
  'kit.title': 'A hero on the counter, not a stamper.',
  ...
  'pt.home': 'HeroPad — The loyalty card you can’t lose',
  'pt.home.d':
...
const ro: Record<TranslationKey, string> = {
  ...
  'strip.1': "Testat live la Bătrânu' Sas, Sibiu",
  'strip.2': '0 aplicații de instalat',
  'strip.3': '10 secunde de la atingere la primul bonus',
  'strip.4': '99 lei pe lună, clienți nelimitați',
  ...
  'kit.title': 'Un erou pe tejghea, nu un stamper.',
  ...
  'eco.league.t': 'Victor League',
  'eco.league.d': 'Platforma de donații — eroii ajută pe bune.',
  'eco.soon': 'În curând',
  ...
  'pt.home': 'HeroPad — Cardul de fidelitate pe care nu îl poți pierde',
  'pt.home.d':
